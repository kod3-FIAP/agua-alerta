...
import type { ZonaEmissaoCreateInput, ZonaEmissaoSelect, ZonaEmissaoUpdateInput } from "../lib/types/types";
...
export const zonaEmissaoService = {
  ...
  async getAllZonasEmissao(args?: Parameters<typeof zonaEmissaoRepository.findAll>[0]): Promise<ZonaEmissaoSelect[]> {
    return zonaEmissaoRepository.findAll(args) as unknown as ZonaEmissaoSelect[];
  },

  async createZonaEmissao(data: ZonaEmissaoCreateInput): Promise<ZonaEmissaoSelect> {
  ...
  async updateZonaEmissao(idZonaEmissao: number, data: ZonaEmissaoUpdateInput): Promise<ZonaEmissaoSelect> {
    ...
    return zonaEmissaoRepository.update(idZonaEmissao, validatedData as ZonaEmissaoUpdateInput) as ZonaEmissaoSelect;
  },
