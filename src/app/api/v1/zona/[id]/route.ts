...
export async function GET(
  ...
  try {
    ...
    console.error(`Falha ao buscar zona de emissão com id ${params.id}:`, error);
...
export async function PUT(
  ...
  try {
    ...
    console.error(`Failed to update zona de emissão with id ${params.id}:`, error);
...
export async function DELETE(
  ...
  try {
    ...
    console.error(`Failed to delete zona de emissão with id ${params.id}:`, error);
